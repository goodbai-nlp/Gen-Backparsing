...
def preprocess_opts(parser):
    ...
    group.add('--train_relation_lst', '-train_relation_lst', required=True)
    group.add('--train_relation_mat', '-train_relation_mat', required=False)
    group.add('--train_align', '-train_align', required=True)
    ...
    group.add('--valid_relation_lst', '-valid_relation_lst', required=True)
    group.add('--valid_relation_mat', '-valid_relation_mat', required=True)

    group.add('--valid_align', '-valid_align', required=True)
...
def train_opts(parser):
    ...
    # structure and node ratio**
    group.add('--ratio_alpha', '-ratio_alpha', type=float, default=1., help="The ratio balancing NMT loss and relation loss")
    group.add('--ratio_beta', '-ratio_beta', type=float, default=1., help="The ratio balancing NMT and supervised attn loss.")
    group.add('--ratio_nmt', '-ratio_nmt', type=float, default=1., help="The ratio balancing NMT loss.")

    group.add('--attn_smoothing', '-attn_smoothing', type=int, default=-1e5,
              help="""attention smoothing value epsilon.""")
    ...
    group.add('--a_drop', '-a_drop', type=float, default=0.1,
              help="Dropout probability; applied in align hidden")
    group.add('--l_drop', '-l_drop', type=float, default=0.1,
              help="Dropout probability; applied in arc_label.")
    group.add('--h_drop', '-h_drop', type=float, default=0.1,
              help="Dropout probability; applied in arc_hidden.")
...
def translate_opts(parser):
    ...
    group.add('--hidden_size', '-hidden_size', type=int, default=512,
              help='Hidden size')
    
    group.add('--integrated_node', '-integrated_node', default=False, action='store_true',
              help='Whether use integrated node information')
    group.add('--integrated_edge', '-integrated_edge', default=False, action='store_true',
              help='Whether use integrated edge information')
